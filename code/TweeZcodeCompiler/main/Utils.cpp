...
std::string Utils::getMallocLib() {
    return ";one data set contains:\n"
            ...
            "\n"
            ";--------------------------------------------------------------------\n"
            ";function sys_char(mem, initialValue):\n"
            ";\tmem:\t\tbyte-adress of an array (or some other memory space)\n"
            ";\tinitialValue:\tinitial value of char\n"
            ";\treturn:\t\tbyte-adress of the char\n"
            "\n"
            ".FUNCT sys_char mem, initialValue, pointer\n"
            "\tcall sys_malloc mem 2 -> pointer\n"
            "\tsub pointer 3 -> pointer\n"
            "\tstoreb pointer 0 6\n"
            "\tadd pointer 3 -> pointer\n"
            ...
            "\n"
            ".FUNCT sys_instanceof pointer, type\n"
            "\tcall sys_typeof pointer -> sp\n"
            "\tje sp type ?YES\n"
            "\trfalse\n"
            "YES:\n"
            "rtrue\n"
