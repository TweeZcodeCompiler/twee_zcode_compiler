...
std::string Utils::getMallocLib() {
    return ";one data set contains:\n"
            ...
            "\n"
            ";--------------------------------------------------------------------\n"
            ";function sys_size(pointer)\n"
            ";\tpointer:\tbyte-adress of the stored type\n"
            ";\treturn:\tsize of the rolled out type"
            "\n"
            ".FUNCT sys_size pointer, count, type, strAddr\n"
            "\tcall sys_typeof pointer -> type\n"
            "\tje type 2 ?NUMBER\n"
            "        je type 3 ?BOOL\n"
            "        je type 4 ?STRING\n"
            "        je type 5 ?CONCAT\n"
            "        je type 6 ?CHAR\n"
            "        je type 7 ?STATIC_STRING\n"
            "        rfalse\n"
            "NUMBER:\n"
            "\tcall sys_size_num pointer count -> count\n"
            "\tret count\n"
            "BOOL:\n"
            "\tret 1\n"
            "STRING:\n"
            "\tloadw pointer 0 -> strAddr\n"
            "\tcall sys_size_string strAddr -> count\n"
            "\tret count\n"
            "CONCAT:\n"
            "\tloadw pointer 0 -> strAddr\n"
            "\tcall sys_size strAddr -> sp\n"
            "\tadd count sp -> count\n"
            "\tloadw pointer 1 -> strAddr\n"
            "\tcall sys_size strAddr -> sp\n"
            "\tadd count sp -> count\n"
            "\tret count\n"
            "CHAR:\n"
            "\tret 2\n"
            "STATIC_STRING:\n"
            "\tcall sys_size_string pointer -> count\n"
            "\tret count"
            "\t\n"
            ".FUNCT sys_size_num num, pos, divender, write, erg\n"
            "\tstore divender 10000\n"
            "\tloadw num 0 -> num\n"
            "\tstore write 0\n"
            "LOOP_NUM:\n"
            "\tje divender 0 ?FINISH\n"
            "\tdiv num divender -> erg\n"
            "\tje erg 0 ?ZERO\n"
            "WRITE:\n"
            "\tstore write 1\n"
            "\tadd pos 2 -> pos\n"
            "\tdiv divender 10 -> divender\n"
            "\tjump ?LOOP_NUM\n"
            "ZERO:\n"
            "\tje write 1 ?WRITE\n"
            "\tdiv divender 10 -> divender\n"
            ...
            "\tret pos"
            "\t\n"
            ".FUNCT sys_size_string str, pos, exit, word, first, second, third\n"
            "\tstore exit 0\n"
            "LOOP_STR:\n"
            "\tloadw str 0 -> word\n"
            "\tand word 32768 -> exit\n"
            "\tand word 31744 -> first\n"
            "\tand word 992 -> second\n"
            "\tand word 31 -> third\n"
            "\tdiv first 1024 -> first\n"
            "\tdiv second 32 -> second\n"
            "\tje exit 0 ?~EXIT\n"
            "\tadd pos 3 -> pos\n"
            "\tadd str 2 -> str\n"
            "\tjump ?LOOP_STR\n"
            "EXIT:\n"
            "\tje third 5 ?SKIP_THIRD\n"
            "\tadd pos 3 -> pos\n"
            "\tret pos\n"
            "SKIP_THIRD:\n"
            "\tje second 5 ?SKIP_SECOND\n"
            "\tadd pos 2 -> pos\n"
            "\tret pos\n"
            "SKIP_SECOND:\n"
            "\tadd pos 1 -> pos\n"
            "\tret pos\n"
            "\n"
            ".FUNCT sys_rollout_string str, pos, exit, word, first, second, third\n"
            "\tstore exit 0\n"
            "LOOP_STR:\n"
            "\tloadw str 0 -> word\n"
            "\tand word 32768 -> exit\n"
            ...
            "\tret pos\n"
            "\n"
            ".FUNCT sys_rollout mem, pointer, currentPosition, size\n"
            "\tcall sys_size pointer -> size\n"
            "\tcall sys_malloc mem size -> currentPosition\n"
            "\tcall_vn sys_dorollout pointer currentPosition\n"
            "\tret currentPosition\n"
            "\n"
            ".FUNCT sys_dorollout pointer, pos, count, type, strAddr\n"
            "\tcall sys_typeof pointer -> type\n"
            "\tje type 2 ?NUMBER\n"
            "        je type 3 ?BOOL\n"
            "        je type 4 ?STRING\n"
            ...
            "        rfalse\n"
            "NUMBER:\n"
            "\tcall sys_rollout_num pointer pos -> pos\n"
            "\tret pos\n"
            "BOOL:\n"
            "\tloadw pointer 0 -> sp\n"
            "\tstoreb pos 0 sp\n"
            ...
            "STRING:\n"
            "\tloadw pointer 0 -> strAddr\n"
            "\tcall_vs sys_rollout_string strAddr pos -> count\n"
            "\tret count\n"
            "CONCAT:\n"
            "\tloadw pointer 0 -> strAddr\n"
            "\tcall sys_dorollout strAddr pos -> pos\n"
            "\tloadw pointer 1 -> strAddr\n"
            "\tcall sys_dorollout strAddr pos -> sp\n"
            "\tret pos\n"
            "CHAR:\n"
            "\tret 2\n"
            "HEHE:\n"
            ...
            "\tret count\n"
            "\n"
            ".FUNCT sys_rollout_num num, pos, divender, write, erg\n"
            "\tstore divender 10000\n"
            "\tloadw num 0 -> num\n"
            "\tstore write 0\n"
            "LOOP_NUM:\n"
            ...
            "\tret pos"
            "\n"
            ".FUNCT sys_comp mem, v1, v2, p1, p2, pos, size1, size2\n"
            "\tje v1 v2 ?EQUALS\n"
            "\tcall sys_rollout mem v1 -> p1\n"
            "\tcall sys_rollout mem v2 -> p2\n"
            "\tsub p1 2 -> p1\n"
            "\tsub p2 2 -> p2\n"
            "\tloadw p1 0 -> size1\n"
            "\tloadw p2 0 -> size2\n"
