...
void SimpleCompilerPipeline::compile(string filename, string zCodeFileName) {
    ...
    routineGenerator.jumpGreaterThan("two", true, 4, 3, false, false);
    //routineGenerator.jumpZero("two", true, 0, false);
